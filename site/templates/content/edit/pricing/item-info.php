        ...
        <?php else : ?>
            ...
            <div class="product-info">
                <ul class="nav nav-tabs nav_tabs hidden-print">
                    ...
                    <li><a href="#<?= $page->stringerbell->format_forjs($item['itemid']); ?>-pricing-tab" data-toggle="tab" aria-expanded="false">Pricings</a></li>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade" id="<?= $page->stringerbell->format_forjs($item['itemid']); ?>-components-tab"><br><?php include $config->paths->content."products/product-results/kit-components.php"; ?></div>
                </div>
            </div>
        <?php endif; ?>
    </div>
