...
<div class="row">
	<div class="col-sm-6">
		<div class="jumbotron item-detail-heading"> <div> <h4>Booking Months</h4> </div> </div>
			...
			<table class="table table-bordered table-condensed table-striped" id="bookings-by-shipto">
				...
				<tbody>
					<?php foreach ($shiptobookings as $shiptobooking) : ?>
						...
						<tr>
							<td><?= $shiptobooking['custid'].' - '.Customer::get_customernamefromid($shiptobooking['custid'], $shiptobooking['shiptoid']); ?></td>
