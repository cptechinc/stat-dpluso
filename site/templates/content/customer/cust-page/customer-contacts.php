...
<?= get_customercontacts($user->loginid, $user->hascontactrestrictions, $custID, true); ?>
    ...
    <div id="contacts-div" class="collapse" data-tableloaded="no" data-shipid="<?= $shipID; ?>">
        ...
        <div class="table-responsive">
            <table class="table table-striped table-bordered" id="contacts-table">
                <thead> <tr>  <th>Name</th> <th>Shipto</th> <th>Title</th> <th>Phone</th> <th>Email</th> <th>Contact Type</th>  </tr> </thead>
                <tbody>
